...
public class TraitWorldSmash extends AbstractTrait {

    public TraitWorldSmash() {
        super("worldsmash", TextFormatting.DARK_GRAY);
    }
    ...
    public void afterBlockBreak(ItemStack tool, World world, IBlockState state, BlockPos pos, EntityLivingBase
        ...
        if (!world.isRemote && tool.canHarvestBlock(state)) {
