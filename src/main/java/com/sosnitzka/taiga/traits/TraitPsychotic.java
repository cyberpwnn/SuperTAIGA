...
public class TraitPsychotic extends TraitProgressiveStats {

    protected static int TICK_PER_STAT = 8;

    public TraitPsychotic() {
        super(TraitPsychotic.class.getSimpleName().toLowerCase().substring(5), TextFormatting.RED);
